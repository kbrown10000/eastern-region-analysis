          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-slate-300">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400">{'\u2713'}</span>
                  <span><strong>Research Triangle market entry</strong> via partner channel (greenfield today)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400">{'\u2713'}</span>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="bg-slate-800/50 rounded-lg p-4">
                  ...
                  <div className="text-slate-500 text-sm">Partner Development Manager (East)</div>
                </div>
                <div className="bg-slate-800/50 rounded-lg p-4">
                  <div className="flex justify-between items-center">
                ...
                <div className="bg-slate-800/50 rounded-lg p-4">
                  ...
                  <div className="text-slate-500 text-sm">$300K investment &rarr; $5M+ pipeline</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="mt-12 bg-slate-900/50 rounded-xl p-6 border border-slate-600">
          ...
          <div className="grid md:grid-cols-2 gap-4 text-xs text-slate-500">
            <ul className="space-y-1">
              <li>&bull; 2025 B2B GTM Benchmarks (Digital Bloom, Kyle Poyar, Maja Voje) - 195 companies</li>
              <li>&bull; ICONIQ Capital State of GTM 2025</li>
              <li>&bull; Dreamdata B2B Benchmarks</li>
            </ul>
            <ul className="space-y-1">
              <li>&bull; Partner2B: 13 B2B Trends Driving Ecosystem Growth 2025</li>
              <li>&bull; Ebsta 2024 B2B Sales Benchmark Report</li>
              <li>&bull; Forrester Partner Ecosystem/Channel Marketing Study 2024</li>
            </ul>
          </div>
        </section>
      </main>
