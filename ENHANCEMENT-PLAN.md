# Eastern Region Growth Strategy - Enhancement Plan
...
USDM has a **$47.9M customer base** across 375 accounts, with **10 Eastern Region biotech targets already customers**. The opportunity is to:
...
## 🔥 KEY DISCOVERY: Eastern Targets Already Customers!
...
- [ ] Filter by Eastern region accounts
...
- [ ] Eastern targets cross-reference
...
- [ ] Regional GP comparison (East 36.5% vs East 51.5%)
...
|--------|---------|--------|--------|
| Eastern Win Rate | 35.6% | 42% | Sales MCP |
